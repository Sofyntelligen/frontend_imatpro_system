...
<template>
  ...
  >
    <div class="aside lg:rounded-2xl flex-1 flex flex-col overflow-hidden dark:bg-slate-900">
      <div class="aside-brand flex flex-row w-full shrink-0 h-14 items-center dark:bg-slate-900">
        <slot />
      </div>
      <div class="aside-scrollbars flex-1 overflow-y-auto overflow-x-hidden">
        <AsideMenuList
          :menu="menu"
