        ...
        >
            {hasPromo && (
                <div className="space-y-12 px-12">
                    ...
                    <div
                        className="hidden md:block py-12 md:py-0 text-center text-white text-opacity-50 dark:text-opacity-80">
                    ...
                    <div className="hidden md:block text-white">
                        <Link href="/">
                            <SofyntelligenLogo className="w-auto h-12 mx-auto"/>
                        </Link>
                    </div>
                </div>
            )}
            ...
            {hasPromo && (
                <div v-if="hasPromo" className="md:hidden space-y-12 py-12">
                    ...
                    <div className="text-white">
                        <Link href="/">
                            <SofyntelligenLogo className="w-auto h-8 mx-auto"/>
                        </Link>
                    </div>
                </div>
            )}
