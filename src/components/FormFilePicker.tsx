...
import {ColorButtonKey} from '../layouts/interfaces'
...
const FormFilePicker = ({label, icon, accept, color, isRoundIcon}: Props) => {
    ...
    return (
        <div className="flex items-stretch justify-start relative">
            ...
            {showFilename && (
                <div
                    className="px-4 py-2 max-w-full flex-grow-0 overflow-x-hidden bg-gray-100 dark:bg-slate-800 border-gray-200 dark:border-slate-700 border rounded-r">
