<script setup>
import { ref } from "vue";
import { buttonMenuOptions } from "@/components/equation/character/ButtonMenuOptionsCharacterMathJax.js";
...
<template>
  <CardBox>
    <BaseLevel v-if="trend" class="mb-3" mobile>
      ...
      <ButtonMenuCharacter :options="buttonMenuOptions(number)" :icon="mdiCog" small />
    </BaseLevel>
    <BaseLevel mobile>
      <div>
